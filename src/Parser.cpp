...
void Parser::handle(char ch) {
    ...
    {
    case 'F':
        turtle_graphic.draw_line();
        break;
    case 'f':
        turtle_graphic.draw_short_line();
        break;
    case '-':
        turtle_graphic.turn_right();
        break;
    case '+':
        turtle_graphic.turn_left();
        break;
    case '[':
        turtle_graphic.save_state();
        break;
    case ']':
        turtle_graphic.pop_state();
        break;
    default:
        // do nothing
        break;
