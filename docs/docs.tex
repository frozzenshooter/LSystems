...
\noindent To control the walking path of turtle some commands are needed. Therefor a defined step size \textit{d} and an angle \textit{$\theta$ } is needed to calculate the next state of the turtle.
...
\end{itemize}
 ...
 The turtle will be initalized with an angle of 60° and an arbitrary length \textit{d} for a step.
