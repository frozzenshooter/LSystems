...
Flexible use als prio - Abstract interface with minimal set of needed functions
Verschiedene implementierungen für verschiedene Frameworks -> nicht unbedingt auf Grafik fokussieren
Verschiedene FUnktionen zur verfügung stellen -> wo liegt die abgrenzung zwischen der implementierung und den notwendigen funktionen (für das L-system)
möglichkeit das auch auf 3D zu machen -> weitere funktionen in den implementierungen wie aufwärts rotieren 

Konfiguration der Turtle muss gemacht werden
