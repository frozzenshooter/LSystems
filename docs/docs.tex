...
Verbessern mit den informationen aus chapter 1 - 1.3 Turtle interpretation -> was wurde davor gentzt -> das hat auch einfluss auf den inhalt der grundlagen -> nochmals verbessern
