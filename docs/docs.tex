...
\noindent This iterator receives a turtle implementation in the constructor and uses it later on to call the mapped commands. The focus of this implementation is based on the simple grammar from previous sections. The implementation only allows the use of chars, because of this. The chars will be assigned and interpreted in the handle function as turtle commands. This implementation allows the use of diffferent turtle implemenntations, in order to still provide the flexibility given by the polymorphism.
